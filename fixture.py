...
try:
    ...
    d0 = Doctor(username="doctor0", email="ethenualgregory@gmail.com", first_name="Alice", last_name="Smith")
    ...
    d3.save()
    d4 = Doctor(username="doctor4", email="edward.miller@hospital.com", first_name="Edward", last_name="Miller")
