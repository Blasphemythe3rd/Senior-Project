...
urlpatterns = [
    ...
    path('settings/<str:testId>/<str:language>/', views.setting, name="settings"), 
    ...
    path('admin/overall_statistics/', views.overall_average_statistics, name='overall_statistics'),    
